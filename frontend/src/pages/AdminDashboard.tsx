...
export default function AdminDashboard() {
  ...
  const completionRate = kpiTotal === 0 ? 0 : (kpiCompleted * 100) / kpiTotal;
  ...
  return (
    <div>
              ...
              <div className="tr" key={t.id}>
                <div>
                  ...
                  <div className="muted small">
                    Assigned to:{" "}
                    <b>
                      {userEmailById[(t as any).owner_id] ||
                        shortId((t as any).owner_id)}
                    </b>
                  </div>

                  <div className="muted small">
                    status:{String(t.can_edit_status)} | content:
                    {String(t.can_edit_content)} | del:{String(t.can_delete)}
                  </div>
      ...
      <Modal
        open={openTask}
        title="Create Task (Assign to A/B)"
